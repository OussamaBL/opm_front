                    ...
                    <div class="modal-body">
                      ...
                      <form id="editUserForm" class="row g-3" onsubmit="return false">
                        ...
                        <div class="col-12 col-md-6" style="margin: 0 auto;">
                          ...
                          <input type="text" id="modalEditUserFirstName" v-model="data.client.montant_facture" class="form-control" placeholder="Saisie libelle" />
                        </div>
                        <div class="col-12 col-md-6" style="margin: 0 auto;">
                          <label class="form-label" for="modalEditUserFirstName">Montant avoir</label>
                          <input type="text" id="modalEditUserFirstName" v-model="data.client.montant_avoir" class="form-control" placeholder="Saisie libelle" />
                        </div>
                        <div class="col-12 col-md-6" style="margin: 0 auto;">
                          <label class="form-label" for="modalEditUserFirstName">Montant réglé</label>
                          <input type="text" id="modalEditUserFirstName" v-model="data.client.montant_regle" class="form-control" placeholder="Saisie libelle" />
                        </div>
                        <div class="col-12 col-md-6" style="margin: 0 auto;">
                          <label class="form-label" for="modalEditUserFirstName">Montant non payé</label>
                          <input type="text" id="modalEditUserFirstName" v-model="data.client.montant_non_paye" class="form-control" placeholder="Saisie libelle" />
                        </div>
