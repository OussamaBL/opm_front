                    ...
                    <div class="modal-body">
                      ...
                      <form id="editUserForm" class="row g-3" onsubmit="return false">
                        ...
                        <div class="col-12 col-md-6" style="margin: 0 auto;">
                          ...
                          <input type="text" id="modalEditUserEmail" v-model="data.mouvement.date" class="form-control" placeholder="Saisie la date" />
                        </div>

                        <div class="col-12 col-md-6" style="margin: 0 auto;">
                          <label class="form-label" for="modalEditUserFirstName">Code prov</label>
                          <input type="text" id="modalEditUserFirstName" v-model="data.mouvement.provenance.code" class="form-control" placeholder="Saisie code prov" />
                        </div>

                        <div class="col-12 col-md-6" style="margin: 0 auto;">
                          <label class="form-label" for="modalEditUserFirstName">libelle prov</label>
                          <input type="text" id="modalEditUserFirstName" v-model="data.mouvement.provenance.libelle" class="form-control" placeholder="Saisie libelle prov" />
                        </div>

                        <div class="col-12 col-md-6" style="margin: 0 auto;">
                          <label class="form-label" for="modalEditUserFirstName">Code dest</label>
                          <input type="text" id="modalEditUserFirstName" v-model="data.mouvement.destination.code" class="form-control" placeholder="Saisie code dest" />
                        </div>

                        <div class="col-12 col-md-6" style="margin: 0 auto;">
                          <label class="form-label" for="modalEditUserFirstName">Libelle dest</label>
                          <input type="text" id="modalEditUserFirstName" v-model="data.mouvement.destination.libelle" class="form-control" placeholder="Saisie libelle dest" />
                        </div>

                        <div class="col-12 col-md-6" style="margin: 0 auto;">
                          <label class="form-label" for="modalEditUserFirstName">Depot</label>
                            <select id="modalEditUserCountry" class="select2 form-select" v-model="data.mouvement.depot_id" data-allow-clear="true">
                        ...
                        <div class="col-12 col-md-6" style="margin: 0 auto;">
                          ...
                          <input type="text" id="modalEditUserFirstName" v-model="data.mouvement.produit_fini.code" class="form-control" placeholder="Saisie code produit" />
                        </div>

                        <div class="col-12 col-md-6" style="margin: 0 auto;">
                          <label class="form-label" for="modalEditUserFirstName">Produit</label>
                            <select id="modalEditUserCountry" class="select2 form-select" v-model="data.mouvement.produit_fini_id" data-allow-clear="true">
                                <option value="">Select</option>
                                <option v-for="produit_fini in data.data_produits_finis" :key="produit_fini.id" :value="produit_fini.id">{{ produit_fini.libelle }}</option>
                            </select>
                        </div>
                        ...
                        <div class="col-12 col-md-6" style="margin: 0 auto;">
                          ...
                          <input type="text" id="modalEditUserFirstName" v-model="data.mouvement.produit_fini.unite.libelle" class="form-control" placeholder="Saisie libelle unite" />
                        </div>

                        <div class="col-12 col-md-6" style="margin: 0 auto;">
                          <label class="form-label" for="modalEditUserFirstName">Qte</label>
                          <input type="text" id="modalEditUserFirstName" v-model="data.mouvement.produit_fini.qte" class="form-control" placeholder="Saisie le quantite de produit" />
                        </div>

                        <div class="col-12 col-md-6" style="margin: 0 auto;">
                          <label class="form-label" for="modalEditUserFirstName">N° document</label>
                          <input type="text" id="modalEditUserFirstName" v-model="data.mouvement.document.N_document" class="form-control" placeholder="Saisie le nemuro de document" />
                        </div>

                        <div class="col-12 col-md-6" style="margin: 0 auto;">
                          <label class="form-label" for="modalEditUserFirstName">Type document</label>
                            <select id="modalEditUserCountry" class="select2 form-select" v-model="data.mouvement.document_id" data-allow-clear="true">
                                <option value="">Select</option>
                                <option v-for="document in data.data_documents" :key="document.id" :value="document.id">{{ document.type_document }}</option>
                            </select>
                        </div> 

                        <div class="col-12 col-md-6" style="margin: 0 auto;">
                          <label class="form-label" for="modalEditUserFirstName">N° de commande</label>
                          <input type="text" id="modalEditUserFirstName" v-model="data.mouvement.commande.N_commande" class="form-control" placeholder="Saisie le nemuro de commande" />
                        </div> 

                        <div class="col-12 text-center">
                          <button v-if="data.action=='add'" type="submit" @click="addMouvement()" class="btn btn-primary me-sm-3 me-1">Submit</button>
                          <button v-if="data.action=='edit'" type="submit" @click="updateMouvement()" class="btn btn-primary me-sm-3 me-1">Submit</button>
                          <button
                            type="button"
  ...
  <!--/ Edit User Modal -->
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="app-ecommerce-category">
                <!-- Category List Table -->
                <div class="card">
                    <button class="btn btn-primary" style="width: 170px;margin: 12px;" data-bs-toggle="modal" @click="open_modal_addMouvement" data-bs-target="#editUser">Ajouter Mouvement</button>
                    <input type="text" v-model="searchQuery" @keyup="fetch_data" class="form-control m-3" style="width: 96%;" placeholder="Rechercher Mouvement...">
                        ...
                        <table v-if="!$data.loading" class="table">
                            ...
                            <tr v-for="mouvement in data.data_mouvements.data" :key="mouvement.id">
                                ...
                                <div class="dropdown">
                                    ...
                                    <a class="dropdown-item" data-bs-toggle="modal" @click="open_modal_updateMouvement(Mouvement)" data-bs-target="#editUser" href="javascript:void(0);">
                                        <i class="ti ti-pencil me-1"></i> Edit
                                    </a>
                                    <a class="dropdown-item" @click="deleteMouvement(Mouvement)" href="javascript:void(0);"
